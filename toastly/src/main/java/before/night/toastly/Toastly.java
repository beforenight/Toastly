...
public class Toastly {
    ...
    private static ToastCompat lastToast = null;
    ...
    public static Toast normal(@NonNull Context context, @StringRes int message, int duration,
        ...
        return custom(context, context.getString(message), icon, ToastlyUtils.getColor(context, R.color.normalColor),
                ToastlyUtils.getColor(context, R.color.defaultTextColor), duration, withIcon, true);
    }

    @CheckResult
    public static Toast normal(@NonNull Context context, @NonNull CharSequence message, int duration,
                               Drawable icon, boolean withIcon) {
        return custom(context, message, icon, ToastlyUtils.getColor(context, R.color.normalColor),
                ToastlyUtils.getColor(context, R.color.defaultTextColor), duration, withIcon, true);
    }
    ...
    public static Toast warning(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastlyUtils.getDrawable(context, R.drawable.ic_error_outline_white_24dp),
                ToastlyUtils.getColor(context, R.color.warningColor), ToastlyUtils.getColor(context, R.color.defaultTextColor),
    ...
    public static Toast warning(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastlyUtils.getDrawable(context, R.drawable.ic_error_outline_white_24dp),
                ToastlyUtils.getColor(context, R.color.warningColor), ToastlyUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast info(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastlyUtils.getDrawable(context, R.drawable.ic_info_outline_white_24dp),
                ToastlyUtils.getColor(context, R.color.infoColor), ToastlyUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast info(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastlyUtils.getDrawable(context, R.drawable.ic_info_outline_white_24dp),
                ToastlyUtils.getColor(context, R.color.infoColor), ToastlyUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast success(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastlyUtils.getDrawable(context, R.drawable.ic_check_white_24dp),
                ToastlyUtils.getColor(context, R.color.successColor), ToastlyUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast success(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastlyUtils.getDrawable(context, R.drawable.ic_check_white_24dp),
                ToastlyUtils.getColor(context, R.color.successColor), ToastlyUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast error(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), ToastlyUtils.getDrawable(context, R.drawable.ic_clear_white_24dp),
                ToastlyUtils.getColor(context, R.color.errorColor), ToastlyUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast error(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, ToastlyUtils.getDrawable(context, R.drawable.ic_clear_white_24dp),
                ToastlyUtils.getColor(context, R.color.errorColor), ToastlyUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
        ...
        return custom(context, context.getString(message), icon, -1, ToastlyUtils.getColor(context, R.color.defaultTextColor),
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
                               int duration, boolean withIcon) {
        return custom(context, message, icon, -1, ToastlyUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, false);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, @DrawableRes int iconRes,
        ...
        return custom(context, context.getString(message), ToastlyUtils.getDrawable(context, iconRes),
                ToastlyUtils.getColor(context, tintColorRes), ToastlyUtils.getColor(context, R.color.defaultTextColor),
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, @DrawableRes int iconRes,
                               @ColorRes int tintColorRes, int duration,
                               boolean withIcon, boolean shouldTint) {
        return custom(context, message, ToastlyUtils.getDrawable(context, iconRes),
                ToastlyUtils.getColor(context, tintColorRes), ToastlyUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, shouldTint);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
                               @ColorRes int tintColorRes, int duration,
                               boolean withIcon, boolean shouldTint) {
        return custom(context, context.getString(message), icon, ToastlyUtils.getColor(context, tintColorRes),
                ToastlyUtils.getColor(context, R.color.defaultTextColor), duration, withIcon, shouldTint);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
                               ...
                               boolean withIcon, boolean shouldTint) {
        return custom(context, context.getString(message), icon, ToastlyUtils.getColor(context, tintColorRes),
                ToastlyUtils.getColor(context, textColorRes), duration, withIcon, shouldTint);
    }
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
                               ...
                               boolean withIcon, boolean shouldTint) {
        final ToastCompat currentToast = ToastCompat.makeText(context, "", duration);
        ...
        if (shouldTint) {
            drawableFrame = ToastlyUtils.tint9PatchDrawableFrame(context, tintColor);
        } else {
            drawableFrame = ToastlyUtils.getDrawable(context, R.drawable.toast_frame);
        }
        ToastlyUtils.setBackground(toastLayout, drawableFrame);

        if (withIcon) {
            if (icon == null) {
                throw new IllegalArgumentException("Avoid passing 'icon' as null if 'withIcon' is set to true");
            }
            ToastlyUtils.setBackground(toastIcon, tintIcon ? ToastlyUtils.tintIcon(icon, textColor) : icon);
        } else {
    ...
    public static class Config {
        private Typeface typeface = Toastly.currentTypeface;
        private int textSize = Toastly.textSize;

        private boolean tintIcon = Toastly.tintIcon;
        ...
        public static void reset() {
            Toastly.currentTypeface = LOADED_TOAST_TYPEFACE;
            Toastly.textSize = 16;
            Toastly.tintIcon = true;
            Toastly.allowQueue = true;
        }
        ...
        public void apply() {
            Toastly.currentTypeface = typeface;
            Toastly.textSize = textSize;
            Toastly.tintIcon = tintIcon;
            Toastly.allowQueue = allowQueue;
        }
    }
}
